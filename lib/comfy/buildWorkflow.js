 ...
 * RunPod·로컬 Comfy API 경로는 전부 이 파일만 읽습니다.
 */
export const WORKFLOW_TEMPLATE_FILE = "z image+rmbg (1).json";
...
/** 사용자 프롬프트 뒤에 붙는 고정 스타일(배경은 항상 이 문구로 끝맺음) */
const FIXED_STYLE_SUFFIX =
  ", Pixar cinematic style, 3D glassmorphism, 3D render, minimal style, high-glossy texture, on a solid chroma key green background, #00FF00, g255, flat color";
